...
class AdvertCard extends Component {
  constructor(props) {
    super(props);
    this.state = {
      imgUrl: props.editData && props.editData.url || '',
      bigImgUrl: props.editData && props.editData.bigurl || '',
      widthImgUrl: props.editData && props.editData.wideurl || '',
      imgWidth: '',
      imgHeight: '',
      bigImgWidth: '',
      bigImgHeight: '',
      widthImgWidth: '',
      widthImgHeight: '',
      jsonName: props.editData && props.editData.url.replace('', '') || '',
  ...
  handleSubmit(e) {
    ...
    form.validateFieldsAndScroll(( err, values ) => {
      if ( !err ) {
        ...
        values.url = this.state.imgUrl;
        values.jsonUrl = '';
        values.imgUrl = '';
        values.bigurl = this.state.bigImgUrl;
        values.wideurl = this.state.widthImgUrl;
    ...
    return (
      ...
      >
        ...
        >
            ...
            initialValue: editData ? editData.detailurl : ''
          } )(
            <Input />
          ) }
          </FormItem>
